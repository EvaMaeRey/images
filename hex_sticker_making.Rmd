...
```{r}
"hex_sticker_making_files/figure-html/" %>% 
list.files(path = .,
           pattern = "cars_flipbook")


magick::image_read("hex_sticker_making_files/figure-html/cars_flipbook_auto_3_output-1.png") %>% 
  magick::image_scale(geometry = "X140") ->
  first_png

magick::image_read("hex_background.png") %>% 
  magick::image_scale(geometry = "X400") %>% 
  magick::image_composite(first_png, offset = "+112+130")
```
...
```{r}
magick::image_read("hex_sticker_making_files/figure-html/cars_flipbook_auto_4_output-1.png") %>% 
  magick::image_scale(geometry = "X140") ->
  first_png
